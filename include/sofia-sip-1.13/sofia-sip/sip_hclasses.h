...
enum {
  /**@ingroup sip_identity @internal
   *
   * Hash of @ref sip_identity "Identity header".
   *
   */
  sip_identity_hash = 60890
};

/**Header class for @ref sip_identity "Identity header".
 *
 * The header class sip_identity_class defines how a SIP
 * @ref sip_identity "Identity header" is parsed and printed.
 * It also contains methods used by SIP parser and other functions to
 * manipulate the #sip_identity_t header structure.
 *
 * @ingroup sip_identity
 *
 */
SIP_DLL extern msg_hclass_t sip_identity_class[];
